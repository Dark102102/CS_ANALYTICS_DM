...
import { ConclusionTab } from '@/components/conclusion-tab';
      ...
      <div className="bg-overlay relative min-h-screen">
        <div className="relative z-10">
          <Tabs defaultValue="introduction" className="w-full" onValueChange={setActiveTab}>
            <Header>
              <TabsList className="grid w-full grid-cols-1 sm:grid-cols-6 md:w-auto bg-transparent border-0 p-0">
                ...
                <TabsTrigger value="conclusion" className="text-lg">Conclusion</TabsTrigger>
              </TabsList>
            </Header>
