...
import { Database, Filter, BarChart, BrainCircuit } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue="collection" className="w-full">
        <TabsList className="grid w-full grid-cols-4 max-w-3xl mx-auto bg-black/30 backdrop-blur-sm">
        ...
        <div className="mt-8">
          ...
          <TabsContent value="models">
            <Card className={cardClassName}>
                <CardHeader>
                  <CardTitle className="text-2xl text-primary">Models Implemented</CardTitle>
